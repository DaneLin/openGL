...
int main()
{
    ...
    // -------------------------
    Shader shader("../src/basic.vs", "../src/basic.fs");
    ...
    unsigned int floorTexture = loadTexture("../src/pics/wood.png", false);
    unsigned int floorTextureGammaCorrected = loadTexture("../src/pics/wood.png", true);
